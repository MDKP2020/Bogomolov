        ...
        <div class="row h-100">
            ...
            <div class="col p-0 d-flex flex-column">
                <div class="row m-0 p-2 border-bottom d-flex align-items-center">
                    ...
                    <a class="btn btn-sm btn-outline-secondary ml-auto" href="/{{$faculty_tab->faculty_id}}/{{$major_tab->major_id}}/{{$group_tab->group_id}}/{{$student_info->student_id}}" role="button">Сохранить</a>
                </div>
                <div class="row m-0 h-100">
                    <div class="container d-flex flex-column m-2 mt-3">
                        <div class="form-group">
                            <label for="student_surname" class="font-weight-bold">Фамилия</label>
                            <input type="text" class="form-control" id="student_surname" value="{{$student_info->surname}}">
                        </div>
                        <div class="form-group">
                            <label for="student_name" class="font-weight-bold">Имя</label>
                            <input type="text" class="form-control" id="student_name" value="{{$student_info->name}}">
                        </div>
                        <div class="form-group">
                            <label for="student_patronymic" class="font-weight-bold">Отчество</label>
                            <input type="text" class="form-control" id="student_patronymic" value="{{$student_info->patronymic}}">
                        </div>
                    </div>
                </div>
            </div>
